...
#  index_pixel_conversions_on_campaign_name                      (campaign_name)
...
#  index_pixel_conversions_on_id_and_pixel_id_and_impression_id  (id,pixel_id,impression_id) UNIQUE
...
#  index_pixel_conversions_on_property_name                      (property_name)
#
require 'test_helper'
